...
public class EmployeeTest {
    ...
    @Before
    public void setUp() {
        emp = new Employee("Test", "User", 8500, 40f, 5f, 20f, "pass123", 0f, false);
    }

    @Test
    public void testAuthSuccess() {
        assertTrue(emp.auth(8500, "pass123"));
    }

    @Test
    public void testAuthFailWrongPassword() {
        assertFalse(emp.auth(8500, "wrong"));
    }

    @Test
    public void testAuthFailWrongID() {
        assertFalse(emp.auth(9999, "pass123"));
    }
    ...
    public void testManagerStatus() {
        ...
        Employee mgr = new Employee("New", "Manager", 7656, 40f, 0f, 30f, "admin", 0f, true);
